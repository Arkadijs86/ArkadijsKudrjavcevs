...
function Tech({ handleAddProduct, value, checked}) {
    ...
    const tech = data.categories.filter(name => name.name === 'tech');

    console.log({ loading, error, data }) ;
    console.log({ tech}) ;
  return <div>
<div className='products'>
<div className='products-category'><h1>TECH</h1></div>
{ checked === true && <div className='products-overlay'></div>}
           {tech[0].products.map((productItem) => (
               <div className='card' >
